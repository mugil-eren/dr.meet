        ...
        <div className="container">
            ...
            lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
                    ...
                    Plan your day, organize work, schedule meetings with your colleagues and external users, manage daily, weekly, and monthly activities – all of this is easily done with Dr.meet.
                    </p>
